...
from LoverMusic.misc import SUDOERS, pymongodb
...
from LoverMusic.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
    ...
    def get_stats():
        ...
        if what in ["Tracks", "Here"]:
            for items, count in list_arranged.items():
                ...
                if items == "telegram":
                    msg += f"🥀 [ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/FALLEN_BOT_SUPPORT) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                else:
...
**🥀ᴍᴏᴅᴜʟᴇs:** {mod}
**🥀ᴄʜᴀᴛs:** {served_chats}0
**🥀ᴜsᴇʀs:** {served_users}0
**🥀ʙʟᴏᴄᴋᴇᴅ:** {blocked}9
**🥀sᴜᴅᴏᴇʀs:** {sudoers} 
**🥀ꜱᴇʀᴠᴇʀ:** [ᴀᴍᴀᴢᴏɴ 64ɢʙ.](t.me/ll_ll_LegendHacker_IN_ll_ll)
    
**🥀ǫᴜᴇʀɪᴇs:** {total_queries} 
**🥀ᴀssɪsᴛᴀɴᴛs:** {assistant}0
**🥀ᴀss ᴀᴜᴛᴏ ʟᴇᴀᴠᴇ:** {ass}
...
**🥀ᴄᴩᴜ ғʀᴇǫᴜᴇɴᴄʏ:** {cpu_freq}
       ...
       <b><u>sᴏғᴛᴡᴀʀᴇ</b><u/>
**🥀ᴋᴀʟɪ-ʟɪɴᴜx :** {pyver.split()[0]}
**🥀ꜱᴘᴏᴛɪꜰʏ :** {pyrover}
**🥀ᴍᴜꜱɪᴄ-ᴛɢᴄᴀʟʟs :** {pytgver}
