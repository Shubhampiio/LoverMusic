...
from LoverMusic.utils import help_pannel
from LoverMusic.utils.database import get_lang, is_commanddelete_on
from LoverMusic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from LoverMusic.utils.inline.help import (help_back_markup,
                                          private_help_panel)
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "ʜᴀᴀɴ ᴀᴀᴊᴀ ʙsᴅᴋ ʟᴜɴᴅ ʟᴇʟᴇ ᴍᴇʀᴀ.\n\nᴊʜᴀᴀᴛ ʙᴀʀᴀᴀʙᴀʀ ᴅɪᴍᴀᴀɢ ʜᴀɪ ɴᴀʜɪ ᴀᴜʀ ᴏᴡɴᴇʀ ʙᴀɴᴇɴɢᴇ.ᴛᴇʀᴀ ᴋʜᴜᴅᴋᴀ ʙɴᴀᴠᴀɴᴀ ʜᴇ ᴛᴏ ᴄᴏɴᴇᴛᴄᴛ ᴋᴀʀʟᴇ ᴘʀᴏ ᴅᴇᴠᴇʟᴏᴘᴇʀ ꜱᴇ @ll_ll_LegendHacker_IN_ll_ll", show_alert=True
            )
        else:
